...
<div style="margin-left: auto;margin-top: 22px;">
  <center>
  <a href="current.php" style="color: white"> <div style="border:1px solid white; background-color:  #010423;width: 33%;height: 50px;float: left; color: white;"><p style="text-align: center;color: white;padding-top: 15px;">Current orders</p> </div> </a>
    <a href="previous.php" style="color: white">  <div style="border:1px solid white;background-color:  #010423;width: 33%;height: 50px;float: left;color: white;">
  <p style="padding-top: 15px;">  Cancelled orders</p>
   </div></a>
    <div style="border:1px solid white;background-color: #010423;width: 33%;height: 50px;float: left;"></div>
    </center>
</div>


<div class="row" style=" margin: 10px;margin-top:10%; background-color:white;">
